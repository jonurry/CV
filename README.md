...
For a complete list, see my [GitHub](https://github.com/jonurry?tab=repositories)
...
| [AWS Lambda Email Service](https://github.com/jonurry/lambda-email-service)    | Serverless email service built using Amazon Web Services, Lambda Function, Node.js, and Simple Email Service (SES).                                                                                         | AWS・_Lambda_・Node.js・_SES_・Serverless Framework                                                                                                                       |
